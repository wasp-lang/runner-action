...
export async function buildAndRunClientApp({ pathToApp, }) {
...
async function buildClientApp({ pathToApp, }) {
...
async function startClientApp({ pathToApp, }) {
    return spawnWithLog({
...
async function getDevEnvVars({ pathToApp, }) {
